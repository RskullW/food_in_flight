...
const Shipping = () => {
  return (
    <Box padding='40px'>
      ...
      <br />
      <br />
      <Text align='justify' fontSize='xl'>Заказы принимаются с 9:00 до 21:00 каждый день в режиме онлайн через наш сайт foodflight.ru или мобильное приложение. Каждый заказ готовится индивидуально и упаковывается непосредственно перед вылетом. Доставка еды осуществляется в космических термосумках, и мы даём гарантию, что она прилетит к вам невредимая и горячая!</Text>
      <br />
      ...
      <br />
      <Text as='b' fontSize='2xl'>В космические пространства:</Text>
      <br />
      ...
      <Text as='b' fontSize='2xl'>На маленькие планеты:</Text>
